# python3.7
"""Configuration for training StyleGAN on LSUN classroom dataset containing 168,103 images.
...
data = dict(
    num_workers=4,
    repeat=298,
    train=dict(root_dir='data/lsun/classroom_train_lmdb', data_format='lmdb',
               resolution=resolution, mirror=0.5, crop_resize_resolution=256),
    val=dict(root_dir='data/lsun/classroom_train_lmdb', data_format='lmdb',
